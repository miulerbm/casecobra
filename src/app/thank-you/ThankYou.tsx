...
const ThankYou = () => {
  ...
  if (data === false) {
    // We are still waiting for the webhook to update our db
    return (
      <div className="w-full mt-24 flex justify-center">
        <div className="flex flex-col items-center gap-2">
          <Loader2 className="h-8 w-8 animate-spin text-zinc-500" />
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              ...
              look good, but also las you for the years to come. We offer a
              5-year print guarantee: If your case isn't of the highest wuality,
