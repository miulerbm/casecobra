...
function ReviewColumn({
  ...
  // the duration of the animation will depend on the size of the space we have available for showing the images. If there is a small space, we can´t make it go fast.
